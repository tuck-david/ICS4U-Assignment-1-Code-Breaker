...
public class code_Breaker {
		...
		do {// Beginning of new game
			...
			do {// loop for each guess of a game
				...
				if (tryCount >= TRIES) {
					...
					if (fullyCorrectAns.length == SIZE) {
						System.out
	 ...
	 *
	 * @param VALID_CHARS
	 *            using the colors in the array to generate the code
	 * @param SIZE
	 *            element of the size/length of the code generated
	...
	/**
	 * Checks if the guess the user has inputted is valid and follows the right
	 * amount of code need to be written and the colors given.
	 *
	 * @param VALID_CHARS
	 ...
	 *            The SIZE/length of the code that the user must guess
	 * @param currentGuess
	 *            Takes the guess and sees if it is valid to the rules
	 ...
	 * @return If the guess has none of the correct color or position then does does
	 *         not return anything, and asks to guess again, if guess has any amount
	 *         of colors and in the correct position will output a number abount of
	 ...
	 * @return If the guess has none of the correct colors then does not return
	 *         anything, and asks to guess again, if guess has any amount of colors
	 *         correct it will output the number amount of correct with w indicating
	 *         a white peg and that the color is correct.
	 */
	...
	public static void rules(String VALID_CHARS, int SIZE, int TRIES) {
		System.out.println("You get " + TRIES + " attempts at breaking the code. \n"
				...
				+ SIZE + " pegs  from " + VALID_CHARS.length() + " available colors.\n"
